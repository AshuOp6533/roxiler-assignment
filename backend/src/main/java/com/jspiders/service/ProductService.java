    ...
    public void initData() {
        ...
        if (products != null) {
            for (Product product : products) {
                // Convert the dateOfSale field to a proper Date object
...
//        long totalSoldItems = products
//        long totalNotSoldItems = productRepository.countNotSoldItemsByMonth(month);
//        List<Product> soldProducts = productRepository.findProductsByMonth(month);
//
//        double totalSaleAmount = soldProducts.stream().mapToDouble(Product::getPrice).sum();
//
//        logger.info("Month: " + month + " Total Sold Items: " + totalSoldItems + " Total Not Sold Items: " + totalNotSoldItems + " Total Sale Amount: " + totalSaleAmount);
//
